...
CREATE OR REPLACE FUNCTION "public"."generate_unique_resource_slug"("input_title" "text") RETURNS "text"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  base_slug text;
...
ALTER FUNCTION "public"."generate_unique_resource_slug"("input_title" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."set_slug_on_content_resource"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  IF NEW.slug IS NULL OR NEW.slug = '' THEN
...
ALTER FUNCTION "public"."set_slug_on_content_resource"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_content_resource_category_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_content_resource_category_updated_at"() OWNER TO "postgres";
...
ALTER TABLE "public"."content_resource_category" OWNER TO "postgres";


ALTER TABLE "public"."content_resource_category" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."content_resource_category_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."content_resource_topics" OWNER TO "postgres";


ALTER TABLE "public"."content_resource_topics" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."content_resource_topics_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."content_resource_category"
    ADD CONSTRAINT "content_resource_category_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."content_resource_topics"
    ADD CONSTRAINT "content_resource_topics_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "content_resource_date_published_idx" ON "public"."content_resource" USING "btree" ("date_published" DESC);



CREATE INDEX "content_resource_resource_category_id_idx" ON "public"."content_resource" USING "btree" ("resource_category_id");



CREATE INDEX "content_resource_status_idx" ON "public"."content_resource" USING "btree" ("status");



CREATE INDEX "content_resource_topics_resource_id_idx" ON "public"."content_resource_topics" USING "btree" ("resource_id");



CREATE INDEX "content_resource_topics_topic_id_idx" ON "public"."content_resource_topics" USING "btree" ("topic_id");
...
CREATE OR REPLACE TRIGGER "set_content_resource_slug" BEFORE INSERT ON "public"."content_resource" FOR EACH ROW EXECUTE FUNCTION "public"."set_slug_on_content_resource"();
...
CREATE OR REPLACE TRIGGER "update_content_resource_category_updated_at" BEFORE UPDATE ON "public"."content_resource_category" FOR EACH ROW EXECUTE FUNCTION "public"."update_content_resource_category_updated_at"();
...
ALTER TABLE ONLY "public"."content_resource"
    ADD CONSTRAINT "content_resource_resource_category_id_fkey" FOREIGN KEY ("resource_category_id") REFERENCES "public"."content_resource_category"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."content_resource_topics"
    ADD CONSTRAINT "content_resource_topics_resource_id_fkey" FOREIGN KEY ("resource_id") REFERENCES "public"."content_resource"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."content_resource_topics"
    ADD CONSTRAINT "content_resource_topics_topic_id_fkey" FOREIGN KEY ("topic_id") REFERENCES "public"."content_topic"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."content_resource"
    ADD CONSTRAINT "content_resource_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."user_profiles"("id");
...
CREATE POLICY "Enable full access for admins" ON "public"."content_resource" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
...
CREATE POLICY "Enable full access for admins" ON "public"."content_resource_category" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."user_id" = "auth"."uid"()) AND ("user_profiles"."is_admin" = true))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."user_id" = "auth"."uid"()) AND ("user_profiles"."is_admin" = true)))));
...
CREATE POLICY "Enable full access for admins" ON "public"."content_resource_topics" TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."user_id" = "auth"."uid"()) AND ("user_profiles"."is_admin" = true))))) WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."user_profiles"
  WHERE (("user_profiles"."user_id" = "auth"."uid"()) AND ("user_profiles"."is_admin" = true)))));
...
CREATE POLICY "Enable full access for service role" ON "public"."content_resource" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "Enable full access for service role" ON "public"."content_resource_category" TO "service_role" USING (true) WITH CHECK (true);



CREATE POLICY "Enable full access for service role" ON "public"."content_resource_topics" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "Enable read access for all users" ON "public"."content_resource" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."content_resource_category" FOR SELECT USING (true);



CREATE POLICY "Enable read access for all users" ON "public"."content_resource_topics" FOR SELECT USING (true);
...
GRANT ALL ON FUNCTION "public"."generate_unique_resource_slug"("input_title" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."generate_unique_resource_slug"("input_title" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_unique_resource_slug"("input_title" "text") TO "service_role";
