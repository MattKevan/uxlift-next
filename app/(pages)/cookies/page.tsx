...
<p>To help explain things as clearly as possible in this Cookie Policy, every time any of these terms are referenced, are strictly defined as:</p>
 <ul>
   ...
   <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to UX Lift, that is responsible for your information under this Cookie Policy.</li>
   ...
   <li>Website:  site, which can be accessed via this URL: https://www.uxlift.org</li>
 </ul>

<h2>Introduction</h2>
<p>This Cookie Policy explains how UX Lift and its affiliates (collectively "UX Lift", "we", "us", and "ours"), use cookies and similar technologies to recognize you when you visit our website, including without limitation https://www.uxlift.org and any related URLs, mobile or localized versions and related domains / sub-domains ("Websites"). It explains what these technologies are and why we use them, as well as the choices for how to control them.</p>
...
<h2>What type of cookies does UX Lift use?</h2>
...
<ul><li>Via Email:  hello@uxlift.org</li>
</ul>
</main>
    )
